...
Both are designed around fast collection, direct use, automation support, and a dockable workflow.
...
- make nulls work well with modern NeoForge modded automation

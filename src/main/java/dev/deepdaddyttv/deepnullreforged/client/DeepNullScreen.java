...
public class DeepNullScreen extends AbstractContainerScreen<DeepNullMenu> {
    ...
    protected void init() {
        ...
        stoneworksAmountBox.setResponder(value -> {
            String sanitized = sanitizeDigits(stoneworksAmountBox, value);
            if (sanitized.equals(value)) {
                onStoneworksAmountChanged(sanitized);
            }
        });
        ...
        customExtractionBox.setResponder(value -> sanitizeDigits(customExtractionBox, value));
    ...
    public void renderStorageCountOverlay(GuiGraphicsExtractor graphics, Slot slot, String overlay) {
        if (customExtractionBox != null && customExtractionBox.visible) {
    ...
    private static String sanitizeDigits(EditBox box, String value) {

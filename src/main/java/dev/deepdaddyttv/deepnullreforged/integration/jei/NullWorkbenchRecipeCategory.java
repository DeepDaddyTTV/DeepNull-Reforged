...
public final class NullWorkbenchRecipeCategory implements IRecipeCategory<NullWorkbenchRecipes.CraftRecipe> {
    ...
    @Override
    public void draw(NullWorkbenchRecipes.CraftRecipe recipe, mezz.jei.api.gui.ingredient.IRecipeSlotsView recipeSlotsView, GuiGraphicsExtractor guiGraphics, double mouseX, double mouseY) {
